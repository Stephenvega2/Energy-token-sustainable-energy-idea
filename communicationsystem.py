...
class EnergyCommSystem:
    def __init__(self, latitude=32.2226, longitude=-110.9747, utc_offset=-7):
        # Initialize blockchain-like storage
        self.transactions = []
        self.metadataMap = {}
        self.ects = {}  # Energy Credit Tokens (NFTs)
        self.ectCounter = 0
    ...
    def mint_ect(self, message, solar_energy_input=10):
        ...
        metadata = {
            ...
            'entropyHash': hashlib.sha256(self.entropy_pool).hexdigest(),
        ...
        self.ects[token_id] = {
            ...
            'metadata': metadata,
            'entropyHash': hashlib.sha256(self.entropy_pool).hexdigest()[:32],
            'energyCredit': energy_credit,
            'timestampStr': self.timestampStr
        }
        self.metadataMap[code_hash] = metadata
        self.ectCounter += 1
    ...
    def encrypt(self, instance):
        ...
        try:
            ...
            self.bundle = {
                ...
                'optimal_params': self.system.ects[self.token_id]['metadata']['optimalParams'],
                'nonce': self.system.ects[self.token_id]['metadata']['nonce'],
                'tag': self.system.ects[self.token_id]['metadata']['tag']
            }
